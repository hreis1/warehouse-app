  ...
  describe '#valid?' do
    context 'when all attributes are present' do
      it 'false when name is blank' do
        apple = Supplier.create!(corporate_name: "Apple", brand_name: "Apple", registration_number: "1234567891011", full_address: "Rua das Flores, 456", city: "Cidade 2", state: "CD", email: "contato@apple.com")
      ...
      it 'false when supplier is blank' do
        apple = Supplier.create!(corporate_name: "Apple", brand_name: "Apple", registration_number: "1234567891011", full_address: "Rua das Flores, 456", city: "Cidade 2", state: "CD", email: "contato@apple.com")
        pm = ProductModel.new(name: "Iphone 11", weight: 194, height: 150, width: 75, depth: 8,sku: "IPHONE-123" ,supplier: nil)
        expect(pm.valid?).to eq false
      end
    end
  end
