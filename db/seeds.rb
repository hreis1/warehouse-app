...
Warehouse.create!(name: "Galpão ADN gerador", code: "ADN", area: 1000, address: "Rua das Flores, 123", city: "Saõ Paulo", cep: "12345678", description: "Galpão de armazenamento de geradores")
...
ProductModel.create!(name: "S20", weight: 157, height: 70, width: 150, depth: 7000,sku: "SAMSUNGABCDEFGHIJKL1" ,supplier: samsung)
ProductModel.create!(name: "Redmi 9", weight: 196, height: 75, width: 150, depth: 8000,sku: "XIAOMIABCDEFGHIJKLMN" ,supplier: xiaomi)
ProductModel.create!(name: "Redmi 10", weight: 196, height: 75, width: 150, depth: 8000,sku: "XIAOMIABCDEFGHIJKLM1" ,supplier: xiaomi)
ProductModel.create!(name: "K10", weight: 168, height: 75, width: 150, depth: 8000,sku: "LGABCDEFGHIJKLMNOPQR" ,supplier: lg)
ProductModel.create!(name: "K11", weight: 168, height: 75, width: 150, depth: 8000,sku: "LGABCDEFGHIJKLMNOPQ1" ,supplier: lg)
ProductModel.create!(name: "Moto G8", weight: 188, height: 75, width: 150, depth: 8000,sku: "MOTOROLAABCDEFGHIJKL" ,supplier: motorola)
ProductModel.create!(name: "Moto G9", weight: 188, height: 75, width: 150, depth: 8000,sku: "MOTOROLAABCDEFGHIJK1" ,supplier: motorola)
ProductModel.create!(name: "Zenfone 6", weight: 190, height: 75, width: 150, depth: 8000,sku: "ASUSABCDEFGHIJKLMNOP" ,supplier: asus)
ProductModel.create!(name: "Zenfone 7", weight: 190, height: 75, width: 150, depth: 8000,sku: "ASUSABCDEFGHIJKLMNO1" ,supplier: asus)
ProductModel.create!(name: "Vibe K6", weight: 140, height: 75, width: 150, depth: 8000,sku: "LENOVOABCDEFGHIJKLMN" ,supplier: lenovo)
ProductModel.create!(name: "Vibe K7", weight: 140, height: 75, width: 150, depth: 8000,sku: "LENOVOABCDEFGHIJKLM1" ,supplier: lenovo)
ProductModel.create!(name: "Xperia XZ", weight: 161, height: 75, width: 150, depth: 8000,sku: "SONYABCDEFGHIJKLMNOP" ,supplier: sony)
